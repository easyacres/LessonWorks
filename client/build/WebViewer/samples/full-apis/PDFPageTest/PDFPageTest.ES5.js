                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 75:
                            return (g = t.sent).initSecurityHandler(), g.lock(), (t.next = 80), g.getPageCount();
                          case 80:
                            d = t.sent;
                          case 81:
                            if (!(d >= 1)) {
                            ...
                            return (t.next = 84), g.getPageIterator(d);
                          case 84:
                            (m = t.sent), g.pageRemove(m), (d -= 2), (t.next = 81);
                            break;
                          case 89:
                            return (t.next = 91), g.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                          case 91:
