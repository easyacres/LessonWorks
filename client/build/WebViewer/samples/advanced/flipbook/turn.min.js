  ...
  var z,
    ...
    g = {
      init: function(a) {
        ...
        var b;
        U = (b = /AppleWebkit\/([0-9\.]+)/i.exec(navigator.userAgent)) ? parseFloat(b[1]) > 534.3 : !0;
        w = T();
        var c;
        b = 0;
        var d = this.data(),
        ...
        for (c = 0; c < e.length; c++) {
          f(e[c]).attr('ignore') != '1' && this.turn('addPage', e[c], ++b);
        }
        f(this)
      ...
      addPage: function(a, b) {
        ...
        b >= 1 &&
          b <= h &&
          ((c = e.display == 'double' ? (b % 2 ? ' odd' : ' even') : ''),
          ...
          (e.pageObjs[b] = f(a)
            .css({ float: 'left' })
            .addClass('page p' + b + c)),
          navigator.userAgent.indexOf('MSIE 9.0') != -1 && e.pageObjs[b].hasClass('hard') && e.pageObjs[b].removeClass('hard'),
      ...
      center: function(a) {
        ...
        b.noCenter ||
          (b.display == 'double' &&
            ((a = this.turn('view', a || b.tpage || b.page)), b.direction == 'ltr' ? (a[0] ? a[1] || (d += c.width / 4) : (d -= c.width / 4)) : a[0] ? a[1] || (d -= c.width / 4) : (d += c.width / 4)),
      ...
      destroy: function() {
        ...
        if (t('destroying', this) != 'prevented') {
          b.destroying = !0;
      ...
      zoom: function(a) {
        ...
        if (typeof a === 'number') {
          ...
          if (t('zooming', this, [a, b.zoom]) == 'prevented') {
            return this;
          }
      ...
      _pageSize: function(a, b) {
        ...
        if (c.display == 'single') {
          ...
          if (b) {
            var f = a % 2;
            d.top = (h - d.height) / 2;
            c.direction == 'ltr' ? ((d[f ? 'right' : 'left'] = e - d.width), (d[f ? 'left' : 'right'] = 'auto')) : ((d[f ? 'left' : 'right'] = e - d.width), (d[f ? 'right' : 'left'] = 'auto'));
          }
        }
        return d;
      },
      ...
      range: function(a) {
        ...
        if (a < 1 || a > e.totalPages) {
          throw q('"' + a + '" is not a valid page');
        }
        d[1] = d[1] || d[0];
        d[0] >= 1 && d[1] <= e.totalPages
          ? ((a = Math.floor(2)), e.totalPages - d[1] > d[0] ? ((b = Math.min(d[0] - 1, a)), (c = 2 * a - b)) : ((c = Math.min(e.totalPages - d[1], a)), (b = 2 * a - c)))
          : (c = b = 5);
      ...
      disable: function(a) {
        ...
        for (b in c.pages) {
          n(b, c.pages) && c.pages[b].flip('disable', c.disabled ? !0 : f.inArray(parseInt(b, 10), d) == -1);
        }
        return this;
      },
      disabled: function(a) {
      ...
      _view: function(a) {
        var b = this.data(),
          a = a || b.page;
        return b.display == 'double' ? (a % 2 ? [a - 1, a] : [a, a + 1]) : [a];
      },
      view: function(a) {
        var b = this.data(),
          a = g._view.call(this, a);
        return b.display == 'double' ? [a[0] > 0 ? a[0] : 0, a[1] <= b.totalPages ? a[1] : 0] : [a[0] > 0 && a[0] <= b.totalPages ? a[0] : 0];
      },
      stop: function(a, b) {
        if (this.turn('animating')) {
          ...
          for (c = 0; c < h.pageMv.length; c++) {
            h.pageMv[c] &&
              ...
              d.force && ((d.next = d.page % 2 === 0 ? d.page - 1 : d.page + 1), delete d.force));
          }
        }
        this.turn('update');
        return this;
      ...
      _missing: function(a) {
        ...
        if (!(b.totalPages < 1)) {
          ...
          d.length > 0 && this.trigger('missing', [d]);
        }
      },
      _fitPage: function(a) {
        var b = this.data(),
      ...
      _turnPage: function(a) {
        ...
        if (d.page != a) {
          var j = d.page;
          if (t('turning', this, [a, i]) == 'prevented') {
            j == d.page && f.inArray(e, d.pageMv) != -1 && d.pages[e].flip('hideFoldedPage', !0);
            return;
          }
          f.inArray(1, i) != -1 && this.trigger('first');
          f.inArray(d.totalPages, i) != -1 && this.trigger('last');
        }
        d.display == 'single' ? ((b = h[0]), (c = i[0])) : h[1] && a > h[1] ? ((b = h[1]), (c = i[0])) : h[0] && a < h[0] && ((b = h[0]), (c = i[1]));
      ...
      page: function(a) {
        ...
        if (!b.disabled && !b.destroying) {
          a = parseInt(a, 10);
          if (a > 0 && a <= b.totalPages) {
            return a != b.page && (!b.done || f.inArray(a, this.turn('view')) != -1 ? g._fitPage.call(this, a) : g._turnPage.call(this, a)), this;
          }
      ...
      peel: function(a, b) {
        ...
        !1 === a
          ...
          : ((d = c.direction == 'ltr' ? (a.indexOf('l') != -1 ? d[0] : d[1]) : a.indexOf('l') != -1 ? d[1] : d[0]), c.pages[d] && c.pages[d].flip('peel', a, b));
        return this;
      },
      ...
      _eventStart: function(a, b, c) {
        ...
        a.isDefaultPrevented() ||
          ...
          d.display == 'single' &&
            c &&
            ((c.charAt(1) == 'l' && d.direction == 'ltr') || (c.charAt(1) == 'r' && d.direction == 'rtl')
      ...
      _eventEnd: function(a, b, c) {
        ...
        if (c) {
          ...
          g._removeMv.call(a, b.page), g._updateShadow.call(a), a.turn('update');
        }
      },
      ...
      _eventReleased: function(a, b) {
        ...
        var d = c.data().f,
          e = d.opts.turn,
          h = e.data();
        c = h.display == 'single' ? (b.corner == 'br' || b.corner == 'tr' ? b.x < c.width() / 2 : b.x > c.width() / 2) : b.x < 0 || b.x > c.width();
        if (new Date().getTime() - d.time < 200 || c) {
      ...
      update: function() {
        var a,
          b = this.data();
        if (this.turn('animating') && b.pageMv[0] !== 0) {
          var c,
          ...
          for (a in b.pageWrap) {
            if (
              ...
              b.pageWrap[a].css({ display: d.pageV[a] || c ? '' : 'none', zIndex: (b.pageObjs[a].hasClass('hard') ? d.partZ[a] : d.pageZ[a]) || (c ? -1 : 0) }),
              (c = b.pages[a]))
            ) {
              c.flip('z', d.partZ[a] || null),
                d.pageV[a] && c.flip('resize'),
                b.tpage ? c.flip('hover', !1).flip('disable', f.inArray(parseInt(a, 10), b.pageMv) == -1 && a != i[0] && a != i[1]) : c.flip('hover', !1 === e).flip('disable', a != h[0] && a != h[1]);
            }
          }
        } else {
          for (a in b.pageWrap) {
      ...
      _updateShadow: function() {
        ...
        switch (a[0] ? (a[1] ? 3 : c.direction == 'ltr' ? 2 : 1) : c.direction == 'ltr' ? 1 : 2) {
          case 1:
            c.shadow.css({
              width: h,
              height: e,
      ...
      _setPageLoc: function(a) {
        ...
        if (a == c[0] || a == c[1]) {
          d = 1;
        } else if ((b.display == 'single' && a == c[0] + 1) || (b.display == 'double' && a == c[0] - 2) || a == c[1] + 2) {
          d = 2;
        }
        if (!this.turn('animating')) {
          switch (d) {
    ...
    i = {
      ...
      _cornerActivated: function(a) {
        ...
        return !a.corner || f.inArray(a.corner, h) == -1 ? !1 : a;
      },
      _isIArea: function(a) {
      ...
      _foldingPage: function() {
        ...
        if (a) {
          var b = a.opts;
          if (b.turn) {
            return (a = b.turn.data()), a.display == 'single' ? (b.next > 1 || b.page > 1 ? a.pageObjs[0] : null) : a.pageObjs[b.next];
          }
        }
      },
      _backGradient: function() {
        var a = this.data().f,
          b = a.opts.turn.data();
        if ((b = b.opts.gradients && (b.display == 'single' || (a.opts.page != 2 && a.opts.page != b.totalPages - 1))) && !a.bshadow) {
      ...
      _fold: function(a) {
        ...
        switch (b.effect) {
          case 'hard':
            a.x = a.corner == 'l' ? Math.min(Math.max(a.x, 0), 2 * e) : Math.max(Math.min(a.x, e), -e);
            var f,
              g,
              s,
              x,
            ...
            switch (a.corner) {
              case 'l':
                x = '0% 50%';
                k = '100% 50%';
                t ? ((f = 0), (g = b.opts.next - 1 > 0), (s = 1)) : ((f = '100%'), (g = b.opts.page + 1 < n), (s = 0));
                break;
              case 'r':
                (x = '100% 50%'), (k = '0% 50%'), (r = -r), (e = -e), t ? ((f = 0), (g = b.opts.next + 1 < n), (s = 0)) : ((f = '-100%'), (g = b.opts.page != 1), (s = 1));
            }
          ...
          case 'sheet':
            ...
            var O = c.opts.acceleration,
              R = b.wrapper.height(),
              E = a.corner.substr(0, 1) == 't',
              C = a.corner.substr(1, 1) == 'l',
              I = function() {
                var b = j(0, 0),
                  f = j(0, 0);
                b.x = d.x ? d.x - a.x : a.x;
      ...
      _moveFoldingPage: function(a) {
        ...
        if (b) {
          ...
          a
            ? ((d = b.opts.next),
              e[d] != b.opts.page && (b.folding && i._moveFoldingPage.call(this, !1), i._foldingPage.call(this).appendTo(b.fpage), (e[d] = b.opts.page), (b.folding = d)),
              c.turn('update'))
            : b.folding &&
      ...
      _showFoldedPage: function(a, b) {
        ...
        if (c) {
          if (!f || !e.point || e.point.corner != a.corner) {
            if (((c = e.status == 'hover' || e.status == 'peel' || e.opts.turn.data().mouseAction ? a.corner : null), (f = !1), t('start', this, [e.opts, c]) == 'prevented')) {
              return !1;
            }
          }
          if (b) {
      ...
      hide: function() {
        ...
        switch (a.effect) {
          case 'hard':
            ...
            break;
          case 'sheet':
            --a.fparent.data().flips === 0 && a.fparent.hide(),
              this.css({
                left: 0,
                top: 0,
                right: 'auto',
        ...
        if (b.point) {
          ...
          if (a) {
            var f = i._c.call(this, d.corner),
              a = d.corner.substr(0, 1) == 't' ? Math.min(0, d.y - f.y) / 2 : Math.max(0, d.y - f.y) / 2,
              g = j(d.x, d.y + a),
              l = j(f.x, f.y - a);
            this.animatef({
              from: 0,
      ...
      _eventEnd: function() {
        var a = this.data().f,
          b = a.corner;
        !a.disabled && b && t('released', this, [a.point || b]) != 'prevented' && i.hideFoldedPage.call(this, !0);
        a.corner = null;
      },
      disable: function(a) {
      ...
      peel: function(a, b) {
        var c = this.data().f;
        if (a) {
          if (f.inArray(a, p.all) == -1) {
            throw q('Corner ' + a + ' is not permitted');
          }
          if (f.inArray(a, i._cAllowed.call(this)) != -1) {
