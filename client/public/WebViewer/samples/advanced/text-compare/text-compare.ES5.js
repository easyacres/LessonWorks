!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var d, y, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), S = 0, w = r ? p(n, x) : a ? p(n, 0) : void 0; x > S; S++)
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      if (
        (I && (x = s(I.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), h.length), 0), O = [], M = 1; M < b.length; M++) O.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var I = [E].concat(O, P, h);
              void 0 !== F && I.push(F);
              var A = String(n.apply(void 0, I));
            } else A = d(E, h, P, O, F, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = a(m, p ? h : h.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (p ? 0 : S)), h.length)) === x) S = u(h, S, y);
              else {
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (i = CoreControls.initPDFWorkerTransports(n, {})), (t.next = 3), Promise.all([a(u[0]), a(u[1])]);
                    case 3:
                      (e = t.sent), (o = r(e, 2)), (f = o[0]), (s = o[1]), f.docViewer.on('documentLoaded', c), s.docViewer.on('documentLoaded', c), c();
                    case 10:
                    case 'end':
                      return t.stop();
                  }
    ...
    var c = function() {
      ...
      a = function(t) {
        return new Promise(function(n) {
          WebViewer({ path: '../../../lib', workerTransportPromise: { pdf: i }, initialDoc: t.initialDoc }, document.getElementById(''.concat(t.domElement))).then(function(r) {
            var e = r.docViewer,
              i = r.CoreControls;
            (t.instance = r),
              r.disableTools(),
                    ...
                    return regeneratorRuntime.wrap(function(o) {
                      for (;;)
                        switch ((o.prev = o.next)) {
                          case 0:
                            (t.loaded = !0), e.getDisplayModeManager().setDisplayMode(new i.DisplayMode(e, i.DisplayModes.Single)), r.setFitMode(r.FitMode.FitWidth), n(r);
                          case 5:
                          case 'end':
                            return o.stop();
                        }
              ...
              e.on('pageNumberUpdated', function(t) {
                var n = u[0].instance === r ? u[1].instance : u[0].instance;
                n.docViewer.getCurrentPage() !== t && n.setCurrentPageNumber(t), s(t);
              }),
              e.on('zoomUpdated', function(n) {
                -1 === document.getElementById(t.domElement).className.indexOf('hidden') && l(n, t.domElement);
              }),
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 2:
                    return (r = t.sent), (t.next = 5), f(u[1].instance, n);
                  case 5:
                    for (
                      e = t.sent, document.querySelector('#'.concat(u[0].diffPanel)).innerHTML = '', document.querySelector('#'.concat(u[1].diffPanel)).innerHTML = '', o = Diff.diffLines(r, e), i = 0;
                      i < o.length;
                      i++
                    )
                      (c = o[i]).removed || c.added
                        ? (function() {
                            var t = '';
                            i + 1 < o.length && (o[i + 1].removed || o[i + 1].added) && ((t = o[i + 1].value), i++);
                            var n = Diff.diffChars(c.value, t),
                              r = '',
                              e = '';
                            ...
                            (s.innerHTML = r), f.appendChild(s), document.querySelector('#'.concat(u[0].diffPanel)).appendChild(f);
                            var l = document.createElement('p');
                            (l.innerHTML = e), a.appendChild(l), document.querySelector('#'.concat(u[1].diffPanel)).appendChild(a);
                            var h = Math.max(a.scrollHeight, f.scrollHeight);
                            (a.style.height = ''.concat(h, 'px')), (f.style.height = ''.concat(h, 'px'));
                          })()
                        : (function() {
                            ...
                            n.addEventListener('click', f),
                              ...
                              document.querySelector('#'.concat(u[0].diffPanel)).appendChild(t),
                              document.querySelector('#'.concat(u[1].diffPanel)).appendChild(n);
                          })();
                  case 10:
                  case 'end':
                    return t.stop();
