    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = Ot(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? O : S('values'), keys: d ? O : S('keys'), entries: A }), g)) for (b in m) b in P || i(P, b, m[b]);
